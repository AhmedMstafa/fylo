        ...
        <div className="relative">
          <div className=" bg-[#1c2230] absolute left-[50%] translate-x-[-50%] top-[-150px] rounded-[5px] element-center flex-col  w-[865px] min-h-[275px]  max-w-full text-white text-center p-[30px]">
            ...
            <p className="w-[620px] max-w-full mx-auto mb-[30px]">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum a ad
              praesentium vero distinctio in consequuntur unde perferendis ab
              aperiam quae voluptatem architecto laborum saepe necessitatibus
              sed mollitia, maxime perspiciatis!
            </p>
            <form className="w-full flex justify-between items-center flex-wrap md:px-[60px] gap-[30px]">
              <input
                type="email"
                placeholder="eamil@example.com"
                className="md:flex-1 w-full  h-[50px] rounded-[30px] pl-[30px] outline-none border-none text-sm text-black font-medium bg-white"
              />
              <button
                type="submit"
